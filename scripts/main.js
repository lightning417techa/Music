...
function MinimizeMiniPlayer() {
 let MiniPlayer = document.getElementById("MiniPlayer");
  if (MiniPlayerSwitch == 1) {MiniPlayerSwitch = 0; document.getElementById("MiniPlayerArror").classList.remove("fa fa-angle-down"); document.getElementById("MiniPlayerArror").classList.add("fa fa-angle-up"); MiniPlayer.classList.remove("MiniPlayerContainer-maximize"); MiniPlayer.classList.remove("MiniPlayerContainer"); MiniPlayer.classList.add("MiniPlayerContainer-minimize");} else {MiniPlayerSwitch = 1; document.getElementById("MiniPlayerArror").classList.remove("fa fa-angle-up"); MiniPlayer.classList.remove("MiniPlayerContainer-minimize"); MiniPlayer.classList.add("MiniPlayerContainer-maximize"); document.getElementById("MiniPlayerArror").classList.add("fa fa-angle-down");}
}
