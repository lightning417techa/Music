...
switch (window.orientation) {  
  ...
  case -90:  
    ...
    document.getElementById("container").style.WebkitAnimation = "-webkit-animation: Minimize-Player 3s"
    document.getElementById("container").style.animation = "animation: Minimize-Player 3s";
    break;  
  case 90:  
