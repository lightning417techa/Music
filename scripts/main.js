...
function Update() {  
  ...
  UpdateScrollController.setAttribute("style", "z-index: 8; border-color: black; position: fixed; left: 50%; top: 40%; transform: translate(-50%, -50%); text-align: left; color: black; font-size: 20px; width: 430px; height: 430px;")
  ...
  Updatetxt2.setAttribute("style", "position: fixed; left: 50%; transform: translate(-50%, -50%); text-align: center; color: black; font-size: 20px; width: 430px;")
