...
function OpenSettings() {
  ...
  SendFeedbackBtn.setAttribute("style", "z-index: 7; position: fixed; left: 5%; transform: translate(-50%, -50%); text-align: right; color: black; font-size: 28px; width: 98%; height: 30px;");
